...
Bool Function OpenQuickOutfitMenu(Actor akTarget) Global Native
Bool Function OpenStudioMenu(Actor akTarget) Global Native
...
Bool Function IsValidOutfitTarget(Actor akTarget) Global Native
Bool Function StartQuickTargetEffect(Actor akTarget) Global Native
Function RestoreQuickTargetEffect() Global Native
...
Int Function ResetOutfitUsageCounts() Global Native
